...
def block():
    ...
    while True:
        ...
        if oy > 320 : # Lane Mid  Lane Out
            turnTimer(0, [20, 88, 0])
            while True:
                turnTimer(0.8, [30, 110, 1])
                break
            time.sleep(0.01)
            numLine += 1
            

        # elif gx < 450 and gx != 0 and gw > 20 and gh > 80:

        #     #turnTimer(0.25, [30, 98, 0])
        #     #turnTimer(0.5, [30, 98, -1])

        #     turnTimer(0.25, [30, 50, 0])
        #     turnTimer(0.9, [40, 50, -1])

        #     turnTimer(0.25, [30, 135, 0])
        #     turnTimer(0.6, [40, 135,  1])

        #     turnTimer(0.25, [30, 50, 0])
        #     turnTimer(1.2, [40, 50, 1])
        #     turnTimer(0.25, [30, 99, 0])
        
        # elif rx > 220 and rw > 20 and rh > 80:

        #     #turnTimer(0.25, [30, 98, 0])
        #     #turnTimer(0.5, [30, 98, -1])
            
        #     turnTimer(0.25, [30, 135, 0])
        #     turnTimer(0.9, [40, 135, -1])

        #     turnTimer(0.25, [30, 50, 0])
        #     turnTimer(0.6, [40, 50,  1])

        #     turnTimer(0.25, [30, 135, 0])
        #     turnTimer(1.2, [40, 135, 1])
        #     turnTimer(0.25, [30, 99, 0])
